                ...
                <dl class="divide-y divide-gray-100">
                    ...
                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                            ...
                            <c:set var="qualificationTypes" value="<%= QualificationType.values() %>" />

                            <select name="Qualification">
                                <c:forEach var="type" items="${qualificationTypes}">
                    ...
                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                            ...
                            <c:set var="positionTypes" value="<%= PositionType.values() %>" />

                            <select name="Position">
                                <c:forEach var="type" items="${positionTypes}">
                                    <option value="${type.index}">${type}</option>
                                </c:forEach>
                            </select>
                        </dd>
